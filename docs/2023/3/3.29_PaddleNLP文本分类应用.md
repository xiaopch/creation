...
- [1. 文本分类应用简介](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/applications/text_classification#文本分类应用简介)

- 2.技术特色介绍
- [2.1 文本分类方案全覆盖](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/applications/text_classification#文本分类方案全覆盖)
  - [2.2 更懂中文的训练基座](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/applications/text_classification#更懂中文的训练基座)
  - [2.3 高效模型调优方案](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/applications/text_classification#高效模型调优方案)
  - [2.4 产业级全流程方案](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/applications/text_classification#产业级全流程方案)
  
- [3. 快速开始](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/applications/text_classification#快速开始)

- [4. 常用中文分类数据集](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/applications/text_classification#常用中文分类数据集)
...
[![image](https://user-images.githubusercontent.com/63761690/189114232-bb706af4-45a9-4e63-8857-76945a63d081.png)](https://user-images.githubusercontent.com/63761690/189114232-bb706af4-45a9-4e63-8857-76945a63d081.png)

#### 2.1.1 分类场景齐全

文本分类应用涵盖多分类（multi class）、多标签（multi label）、层次分类（hierarchical）三种场景，接下来我们将以下图的新闻文本分类为例介绍三种分类场景的区别。

[![image](https://user-images.githubusercontent.com/63761690/186378697-630d3590-4e67-49a0-8d5f-7cabd9daa894.png)](https://user-images.githubusercontent.com/63761690/186378697-630d3590-4e67-49a0-8d5f-7cabd9daa894.png)
...
[![img](https://user-images.githubusercontent.com/63761690/189115968-c1d14ed3-dbdd-4a84-ac11-e9eaa447d40f.png)](https://user-images.githubusercontent.com/63761690/189115968-c1d14ed3-dbdd-4a84-ac11-e9eaa447d40f.png)
...
【方案选择】提示学习（Prompt Learning）适用于**标注成本高、标注样本较少的文本分类场景**。在小样本场景中，相比于预训练模型微调学习，提示学习能取得更好的效果。对于标注样本充足、标注成本较低的场景，我们仍旧推荐使用充足的标注样本进行文本分类[预训练模型微调](https://github.com/PaddlePaddle/PaddleNLP/tree/develop/applications/text_classification#预训练模型微调)。
...
[![img](https://user-images.githubusercontent.com/63761690/189114324-376025b6-8f4e-4d94-a135-953f53f20636.png)](https://user-images.githubusercontent.com/63761690/189114324-376025b6-8f4e-4d94-a135-953f53f20636.png)

【方案效果】我们比较预训练模型微调与提示学习在多分类、多标签、层次分类小样本场景的模型表现（多分类精度为准确率，多标签和层次分类精度为Macro F1值），可以看到在样本较少的情况下，提示学习比预训练模型微调有明显优势。

[![文本分类落地难点](https://user-images.githubusercontent.com/63761690/189114445-ee0dd6af-f102-4708-9f46-c630c572dfd3.png)](https://user-images.githubusercontent.com/63761690/189114445-ee0dd6af-f102-4708-9f46-c630c572dfd3.png)
...
[![img](https://user-images.githubusercontent.com/63761690/189114541-2278b7f7-1af6-470d-a300-28e7e902b6a8.png)](https://user-images.githubusercontent.com/63761690/189114541-2278b7f7-1af6-470d-a300-28e7e902b6a8.png)
...
文本分类应用使用**ERNIE 3.0轻量级模型作为预训练模型**，ERNIE 3.0 轻量级模型是文心大模型ERNIE 3.0基础上通过在线蒸馏技术得到的轻量级模型。下面是ERNIE 3.0 效果-时延图，ERNIE 3.0 轻量级模型在精度和性能上的综合表现已全面领先于 UER-py、Huawei-Noah 以及 HFL 的中文模型，具体的测评细节可以见[ERNIE 3.0 效果和性能测评文档](https://github.com/PaddlePaddle/PaddleNLP/blob/develop/model_zoo/ernie-3.0)。

[![img](https://user-images.githubusercontent.com/63761690/186376051-6c3ca239-1e31-4c0a-bdbe-547439234ddb.png)](https://user-images.githubusercontent.com/63761690/186376051-6c3ca239-1e31-4c0a-bdbe-547439234ddb.png)
...
[![文本分类落地难点](https://user-images.githubusercontent.com/63761690/189114644-c0d21801-dd6c-4530-b3a3-5f5a568a7a22.png)](https://user-images.githubusercontent.com/63761690/189114644-c0d21801-dd6c-4530-b3a3-5f5a568a7a22.png)

我们采用在多分类、多标签、层次分类场景中评测稀疏数据-数据增强策略和稀疏数据-数据标注策略，下图表明稀疏数据筛选方案在各场景能够有效提高模型表现（多分类精度为准确率，多标签和层次分类精度为Macro F1值）。

[![文本分类落地难点](https://user-images.githubusercontent.com/63761690/189114660-820d1471-4907-4c73-a118-c494200afff0.png)](https://user-images.githubusercontent.com/63761690/189114660-820d1471-4907-4c73-a118-c494200afff0.png)

- **脏数据清洗**基于表示点方法的实例级证据分析方法，计算训练数据对模型的影响分数，分数高的训练数据表明对模型影响大，这些数据有较大概率为脏数据（标注错误样本）。脏数据清洗方案通过高效识别训练集中脏数据（也即标注质量差的数据），有效降低人力检查成本。

[![文本分类落地难点](https://user-images.githubusercontent.com/63761690/189114677-9a2f5232-9551-4e10-a215-54ddb7ca1f33.png)](https://user-images.githubusercontent.com/63761690/189114677-9a2f5232-9551-4e10-a215-54ddb7ca1f33.png)

我们采用在多分类、多标签、层次分类场景中评测脏数据清洗方案，实验表明方案能够高效筛选出训练集中脏数据，提高模型表现（多分类精度为准确率，多标签和层次分类精度为Macro F1值）。

[![文本分类落地难点](https://user-images.githubusercontent.com/63761690/189114695-90cef2fd-955d-4243-9fc4-78f2dcf7fb6c.png)](https://user-images.githubusercontent.com/63761690/189114695-90cef2fd-955d-4243-9fc4-78f2dcf7fb6c.png)
...
[![文本分类落地难点](https://user-images.githubusercontent.com/63761690/189115071-40152f7c-7c90-41b3-a70b-4d4aabc5b715.png)](https://user-images.githubusercontent.com/63761690/189115071-40152f7c-7c90-41b3-a70b-4d4aabc5b715.png)
...
[![image](https://user-images.githubusercontent.com/63761690/189115101-20cbaa00-e549-425b-b047-61bac2a5e39f.png)](https://user-images.githubusercontent.com/63761690/189115101-20cbaa00-e549-425b-b047-61bac2a5e39f.png)

文本分类应用全流程示意图

**1.数据准备阶段**

- 我们根据文本分类任务选择对应的场景目录: [多分类场景目录](https://github.com/PaddlePaddle/PaddleNLP/blob/develop/applications/text_classification/multi_class)、 [多标签场景目录](https://github.com/PaddlePaddle/PaddleNLP/blob/develop/applications/text_classification/multi_label)、[层次分类场景目录](https://github.com/PaddlePaddle/PaddleNLP/blob/develop/applications/text_classification/hierarchical)。
...
[![image](https://user-images.githubusercontent.com/63761690/189115124-2f429043-3145-4bf8-9969-47580a706037.png)](https://user-images.githubusercontent.com/63761690/189115124-2f429043-3145-4bf8-9969-47580a706037.png)
...
- [百科问答分类数据集](https://github.com/brightmart/nlp_chinese_corpus#3百科类问答json版baike2018qa)
